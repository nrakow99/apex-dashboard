...
export default function SettingsPage() {
  ...
  return (
    <AppShell eyebrow="Workspace" title="Settings" description="Control risk assumptions, instrument specifications, and connected app capabilities.">
      ...
      <div className="mt-6"><DataManagementPanel accounts={accounts} trades={trades} payouts={payouts} accountCosts={accountCostsAvailable ? accountCosts : null} /></div>
