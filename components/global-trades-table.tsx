            ...
            {visibleTrades.map((trade) => {
              ...
              return (
                <tr key={trade.id} className="transition-colors hover:bg-[var(--raised)]/60">
                  ...
                  <td className="px-4 py-3.5 text-[10px] uppercase tracking-[0.12em] text-[var(--muted)]">{trade.importSource === "screenshot" ? "Screenshot" : trade.importSource === "csv" || trade.notes?.startsWith("Imported from CSV:") ? "CSV" : "Manual"}</td>
