...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-[2px]">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-11 px-4 text-left align-middle text-[10px] font-medium uppercase tracking-[0.14em] text-slate-400/90 [&:has([role=checkbox])]:pr-0',
      className,
    )}
    {...props}
  />
