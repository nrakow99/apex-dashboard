  ...
  return (
    <>
      ...
      >
        ...
        <span>{progress.isComplete ? "Product guide" : `Setup ${progress.completed}/${progress.total}`}</span>
      ...
      <Dialog open={open} onOpenChange={(next) => { if (!next) close() }}>
        <DialogContent className="max-h-[88vh] overflow-y-auto rounded-[2px] border-[var(--hairline)] bg-[var(--surface)] sm:max-w-[620px]">
          <DialogHeader>
            ...
            <DialogTitle className="text-2xl tracking-[-0.035em]">Set up payout intelligence</DialogTitle>
          ...
          <div className="mt-5 flex flex-col gap-3 border border-[var(--hairline)] bg-[var(--raised)] p-4 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-start gap-2 text-xs text-[var(--muted)]">
              ...
              <p>No sample balances or rule values are inserted. The guide completes only from real workspace data and pages you visit.</p>
            </div>
