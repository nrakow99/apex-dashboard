...
const pageHelp: Record<string, { title: string; description: string; actions: string[] }> = {
  ...
  "/review": { title: "Turn results into evidence", description: "History, importing, and Edge share one review loop; findings keep their sample size and remain historical.", actions: ["Keep results current", "Add useful context", "Repeat strengths, remove leaks"] },
...
export function OnboardingGuide() {
  ...
  const waitingInWorkspace = (stage === "account" && pathname === "/accounts") || (stage === "history" && pathname === "/review")
